#############################################################################
# Makefile for building: appconfig_0/work/chn_ui/chn_ui
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  chn_ui.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile chn_ui.pro -qtconf /usr/lib/aarch64-linux-gnu/qt5/qt.conf -early QMAKE_CC=aarch64-linux-gnu-gcc QMAKE_CXX=aarch64-linux-gnu-g++ QMAKE_LINK=aarch64-linux-gnu-g++ QMAKE_STRIP=aarch64-linux-gnu-strip QMAKE_QMAKE=/usr/bin/aarch64-linux-gnu-qmake PKG_CONFIG=aarch64-linux-gnu-pkg-config -before CONFIG+=debug
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = chn_ui1.0.0
DISTDIR = /workspaces/chn_ui/.tmp/chn_ui1.0.0
...
SOURCES       = chn_ui.cpp qrc_qml.cpp
OBJECTS       = chn_ui.o \
		qrc_qml.o
DIST          = /usr/lib/aarch64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		chn_ui.pro chn_ui.h chn_ui.cpp
QMAKE_TARGET  = chn_ui
DESTDIR       = appconfig_0/work/chn_ui/
TARGET        = appconfig_0/work/chn_ui/chn_ui


first: all
####### Build rules

appconfig_0/work/chn_ui/chn_ui:  $(OBJECTS)  
	@test -d appconfig_0/work/chn_ui/ || mkdir -p appconfig_0/work/chn_ui/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: chn_ui.pro /usr/lib/aarch64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/aarch64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		chn_ui.pro \
		qml.qrc
	$(QMAKE) -o Makefile chn_ui.pro -qtconf /usr/lib/aarch64-linux-gnu/qt5/qt.conf -early QMAKE_CC=aarch64-linux-gnu-gcc QMAKE_CXX=aarch64-linux-gnu-g++ QMAKE_LINK=aarch64-linux-gnu-g++ QMAKE_STRIP=aarch64-linux-gnu-strip QMAKE_QMAKE=/usr/bin/aarch64-linux-gnu-qmake PKG_CONFIG=aarch64-linux-gnu-pkg-config -before CONFIG+=debug
...
all: Makefile appconfig_0/work/chn_ui/chn_ui
...
distdir: FORCE
	...
	$(COPY_FILE) --parents chn_ui.h $(DISTDIR)/
	$(COPY_FILE) --parents chn_ui.cpp $(DISTDIR)/
...
chn_ui.o: chn_ui.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o chn_ui.o chn_ui.cpp
